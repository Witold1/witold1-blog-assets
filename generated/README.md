...
CI publishes this folder to GitHub Pages. The site should link keys under this tree via `mediaBaseUrl` / `NEXT_PUBLIC_MEDIA_BASE_URL` (for example `https://witold1.github.io/witold1-blog-assets/`).
